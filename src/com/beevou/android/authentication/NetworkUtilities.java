...
package com.beevou.android.authentication;
...
public class NetworkUtilities {
    ...
    public static final String BASE_URL ="https://beevou.net/api";
    public static final String AUTH_URI = BASE_URL + "/oauth/token/?layout=json";
   ...
   /* 
    ...
    public static boolean authenticate(String username, String password,
    	...
    	JSONObject token = jsonParser.getJSONFromUrl("https://beevou.net/oauth/token?grant_type=password&username="+username+"&password="+password+"&client_id=NTEyMWZmNTdkZDVlMDVm&client_secret=438a58c31557b2db11523a2dc350e74fae06e0d2");
