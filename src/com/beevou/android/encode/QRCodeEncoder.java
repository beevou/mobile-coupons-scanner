...
package com.beevou.android.encode;
...
public final class QRCodeEncoder {
  ...
  public QRCodeEncoder(Activity activity, Intent intent) {
    ...
    if (intent == null) {
      throw new IllegalArgumentException(activity.getString(R.string.no_valid_data_to_encode_));
    }
  ...
  static Bitmap encodeAsBitmap(String contents,
    ...
    {
    	//desiredHeight = Integer.valueOf(desiredHeight/2);
    	desiredWidth = Integer.valueOf(desiredWidth*2);
    }
    /*
    if (desiredWidth > 400)
    	desiredWidth = 400;
    ...
    */
    ...
    Log.e("desiredWidth",String.valueOf(desiredWidth));
    Log.e("desiredHeight",String.valueOf(desiredHeight));
    
    
    
   // VER LA MANERA DE QUE COJA TODO EL ANCHO DE LA PANTALLA
