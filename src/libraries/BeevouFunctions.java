...
public class BeevouFunctions {
 
	private static BeevouFunctions mInstance= null;
	...
	//YOU HAVE TO INSERT HERE YOUR CLIENTID AND CLIENT SECRET - Get it from My account in beevou
	static String clientID = "YOUR - CLIENTID";
	static String clientSecret = "YOUR -- CLIENT SECRET";

	
    protected BeevouFunctions(){
        jsonParser = new JSONParser();
    }
    
    

    public static synchronized BeevouFunctions getInstance(){
    	if(null == mInstance){
    		mInstance = new BeevouFunctions();
    	}
    	return mInstance;
    }
